...
namespace ofic.Controllers
{
    ...
    public class LoginVisualController : ControllerBase
    {
        ...
        public IActionResult GetConfig()
        {
            ...
            {
                _logger.LogError(ex, "Error consultando configuración visual del login");
                return StatusCode(500, new { message = "Error consultando configuración visual del login." });
            }
        }
        ...
        public IActionResult GetAdminConfig()
        {
            ...
            {
                _logger.LogError(ex, "Error consultando configuración admin visual del login");
                return StatusCode(500, new { message = "Error consultando configuración admin visual del login." });
            }
        }
